...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // ✅ LANGUAGE FLOW
    Route::get('/languages/{id}', [LanguageController::class, 'show']); // Get single language
    Route::get('/languages/{id}/sections', [SectionController::class, 'getByLanguage']);

    // ✅ SECTION FLOW  
    Route::get('/sections/{id}', [SectionController::class, 'show']); // Get single section
    Route::get('/sections/{id}/parts', [PartController::class, 'getBySection']);

    // ✅ PART LEARNING FLOW
    Route::get('/parts/{id}', [PartController::class, 'show']); // Get single part
    ...
    Route::post('/progress/complete-exercise', [ProgressController::class, 'completeExercise']);
        Route::get('/progress/part/{partId}', [ProgressController::class, 'getPartProgress']); // ✅ ROUTE BARU
